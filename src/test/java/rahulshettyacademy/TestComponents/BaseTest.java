...
public class BaseTest {
	...
	public WebDriver initializeDriver() throws IOException 
	{
		...
		{
			//FireFox
			System.setProperty("webdriver.gecko.driver", "D:\\Switch@2025\\DependencyThings\\geckodriver-v0.36.0-win64");
	...
	public LandingPage lunchAplication() throws IOException 
	{
       ...
       landingpage = new LandingPage(driver);  // Link to page object
